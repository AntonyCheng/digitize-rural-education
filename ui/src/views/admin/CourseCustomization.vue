<template>
  <div class="control">
      <el-button @click="dialogFormVisible = true" class="btn">上传定制资源</el-button>
  </div>
...
<div class="pagination">
  ...
  <el-dialog v-model="dialogFormVisible" title="新增定制课程" width="500">
      <span>请输入资源标题</span>
...
<div style="margin: 20px 0" />
      ...
      drag
      name="multipartFile"
       action="http://localhost:38080/api/admin/file/upload_customize_file"
       with-credentials
...
export default{
  ...
  methods:{
    upLoadFile(){
        Axios({
          url: 'http://localhost:38080/api/admin/resource/add_customize',
          method: 'post',
          data:{
              'title':this.title,
              'info':this.info,
    ...
    getFileList(){
      Axios({
          url: 'http://localhost:38080/api/admin/file/upload_customize_file',
          method: 'get',
          params: {
